...
using ParseResult =
    Ruzzie.Common.Types.Result<Ruzzie.Common.Types.Err<Ruzzie.Ean.ISBNParseErrorKind>, Ruzzie.Ean.ISBN13.Metadata>;
...
public class ISBN13Parser : IISBNParser
{
    ...
    public ParseResult Parse(string originalInput)
    {
        ...
        {
            return new ParseError($"Input {originalInput} is not a valid EAN13 number: {originalInput}"
    ...
    private ParseResult Parse(Ean13 ean13, string originalInput)
    {
        ...
        {
            return new ParseError($"Ean: {originalInput}, is not a valid ISBN13 number."
                                , ISBNParseErrorKind.InvalidISBN13);
        }

        return metadataOption.Match<ParseResult>(() => new ParseError(
