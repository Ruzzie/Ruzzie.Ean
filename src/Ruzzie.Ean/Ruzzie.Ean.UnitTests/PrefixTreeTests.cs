...
public class PrefixTreeTests
{
    ...
    public PrefixTreeTests()
    {
        _treeUnderTest = new PrefixTree(
                                      ...
                                      , new[]
                                        {
                                            new RangeRule(0, 4, 1), new RangeRule(11, 22, 2)
                                        });

        _treeUnderTest.AddChild("0"
                              , 1
                              , "English language"
                              , new[]
                                {
                                    new RangeRule(00, 12, 2), new RangeRule(229, 368, 3)
                                });
    }
    ...
    public void AddChildTest()
    {
        ...
        bool addResult = tree.AddChild("0"
                                     , 1
                                     , "English language"
                                     , new[]
                                       {
